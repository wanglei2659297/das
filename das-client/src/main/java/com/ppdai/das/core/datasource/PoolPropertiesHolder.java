...
//
//    private static ConcurrentHashMap<String, ConcurrentHashMap<String, IctPoolProperties>> poolPropertiesMap =
//            new ConcurrentHashMap<>();
//
//    public void setPoolProperties(IctPoolProperties poolProperties) {
...
//        ConcurrentHashMap<String, IctPoolProperties> map = poolPropertiesMap.get(url);
//
//        if (map == null) {
//            synchronized (LOCK) {
...
//    }
//
//    public IctPoolProperties getPoolProperties(String url, String userName) {
//        if (url == null || url.length() == 0) {
//            return null;
//        }
//        if (userName == null || userName.length() == 0) {
